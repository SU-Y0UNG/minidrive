...
| 메인 화면 | 우클릭 메뉴 |
|:---:|:---:|
| ![메인화면](images/main.png) | ![우클릭메뉴](images/context_menu.png) |

### 파일 관리
드래그앤드롭 업로드, 파일 미리보기, 폴더 이동 기능을 제공합니다.

| 드래그앤드롭 업로드 | 파일 미리보기 | 폴더 이동 |
|:---:|:---:|:---:|
| ![업로드](images/upload.png) | ![미리보기](images/preview.png) | ![이동](images/move.png) |

### 고급 기능
예약 업로드, 중복 파일 감지, 자동 분류, 휴지통 기능을 제공합니다.

| 예약 업로드 | 중복 파일 감지 |
|:---:|:---:|
| ![예약업로드](images/scheduled_upload.png) | ![중복감지](images/duplicate.png) |

| 자동 분류 규칙 | 휴지통 |
|:---:|:---:|
| ![자동분류](images/auto_classify.png) | ![휴지통](images/trash.png) |
...
| 공유 링크 생성 | 링크 복사 |
|:---:|:---:|
| ![공유생성](images/share_create.png) | ![링크복사](images/share_copy.png) |
